  ...
  <el-dialog :model-value="modelValue" :title="title" width="980px" @close="emitClose">
    <div class="dialog-grid">
      <section class="panel">
        ...
        <el-form :model="localForm" :rules="isDetail ? undefined : rules" ref="formRef" label-width="90px">
          <el-form-item label="部门名称">
            <el-select v-model="localForm.deptName" disabled>
              <el-option :label="localForm.deptName" :value="localForm.deptName" />
            </el-select>
          </el-form-item>
          <el-form-item label="岗位名称" prop="postName">
            <el-input
              v-model="localForm.postName"
              maxlength="50"
              placeholder="请输入岗位名称"
          ...
          <el-form-item label="岗位类型">
            <el-select v-model="localForm.postType" disabled>
...
const title = computed(() => (props.mode === 'add' ? '新增' : props.mode === 'edit' ? '修改' : '详情'))
